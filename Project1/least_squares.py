...
class LeastSquares:
    def __init__(self, N = 100, method = 'ols', noise_magnitude = 0.01, polynomial_degree = 5):
        ...
        self.x, self.y = self.init_data(noise_magnitude)
    ...
    def cross_validation(self, x, y, design_matrix, k):
        """
        Implementation of the k-fold cross validation algorithm.
        """

        fold_size = np.shape(x)[0] // k
        print(fold_size)
    ...
    def ordinary_least_squares(self, design_matrix, z):
        """
